...
- [ ] 2.1 token_manager の issue / verify / TTL 検証を実装（Red: Unit-09, 10, 14）
...
- [ ] 2.2 token_manager の design_hash canonicalization と auto mode 分配（Red: Unit-11, 12, 13）
...
- [ ] 2.3 manifest_writer を実装（Red: Unit-15〜18, 23）
...
- [ ] 2.4 crash_recovery を実装（Red: Unit-20, 21, 22）
