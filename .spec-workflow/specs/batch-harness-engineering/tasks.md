...
- [x] 3.1 history_query を実装（Red: Unit-19）
...
- [x] 3.2 risk_evaluator を実装（Red: Unit-01〜07）
...
- [x] 4.1 /premortem skill (SKILL.md + CLI 骨格) を実装
...
- [x] 4.2 /batch-analysis launcher を更新 (stream-json + --approved-by + Phase A/B + crash recovery)
...
- [x] 4.3 batch-prompt.md に manifest 書き出し指示を追記
...
- [x] 5.1 stub_claude.py と E2E fixtures を整備
...
- [x] 5.2 E2E harness (setup / teardown / assert_helpers / claude_wrapper) と assertions を整備
...
- [x] 5.3 E2E runners (bash スクリプト 3 本) を整備
...
- [x] 6.1 Integration tests - premortem 系 (CLI / modes / io_contract / performance)
...
- [x] 6.2 Integration tests - launcher 系 (batch_launcher / session_id / manifest_atomic)
...
- [x] 6.3 Integration tests - recovery + mode × risk matrix
...
- [x] 6.4 Integration tests - security + methodology_tag retry
...
- [x] 7.1 ドキュメント更新 (CLAUDE.md + README + structure.md)
...
- [x] 7.2 package_allowlist.yaml への分離 (改善 I-3)
